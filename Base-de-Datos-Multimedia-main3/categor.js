$(document).ready(function(){
    ...
    cargaCategor();
    cargaDatosCategoria();
    cargaCursosDeCategoria();

    function cargaDatosCategoria(){
        var dataToSend = {
            action: "getDatosCategor"
        };
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (let index = 0; index < objectLength; index++) {
                    ...
                    $(".bienvenidoPrincipal").append("<h3>"+ Object.values(data[index].nombreCat).join("") +"</h3>");
                    $(".imgDescripcion").append("<img src='uploads/"+ Object.values(data[index].fotoCat).join("") +"' alt='imagen01'></img>");
                    $(".imgDescripcion").append("<h6>"+ Object.values(data[index].descripcionCat).join("") +"</h6>");
    ...
    function cargaCursosDeCategoria(){
        var dataToSend = {
            action: "getCursosCategor"
        };
