          ...
          alert(data);
						...
						for (let index = 0; index < objectLength; index++) {
							$(".product-list").append(
								...
								+ Object.values(data[index].p_detail).join("") + "</p><p>$" 
								+ Object.values(data[index].p_price).join("") + "</p><button class='btnEliminar'>Eliminar<p class='ID' style='visibility: hidden; display: none;'>" 
								+ Object.values(data[index].id_product).join("") + 
								"</p></button></div>");
						}
        },
